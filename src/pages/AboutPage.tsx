    ...
    <div className="min-h-screen bg-cwail-bg">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-12">
          ...
          <RevealOnScroll>
            <section className="cwail-surface rounded-xl shadow-cwail dark:shadow-cwail-dark p-8">
              <h2 className="text-2xl font-display font-semibold text-cwail-ink mb-4">Team</h2>
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start mb-10 relative">
              ...
              <div className="flex-1">
                <div className="flex justify-between items-start mb-2">
                  <div>
                    <h3 className="text-xl font-semibold text-cwail-ink">Joseph Forte</h3>
                    <p className="text-cwail-ink font-medium">Senior Lecturer</p>
                    <p className="text-cwail-muted">Center for Leadership Education</p>
                  </div>
                  {/* JHU logo */}
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start">
              ...
              <div className="flex-1">
                <div className="flex justify-between items-start mb-2">
                  <div>
                    <h3 className="text-xl font-semibold text-cwail-ink">Joseph Gonzaludo</h3>
                    <p className="text-cwail-ink font-medium">Software Engineering Intern</p>
                    <p className="text-cwail-muted">NASA | Johns Hopkins University</p>
                  </div>
                  {/* NASA logo */}
                  <div className="flex items-center ml-4">
                    <img
                ...
                <p className="text-cwail-muted">Contact: <a href="mailto:jgonz102@jh.edu" className="text-cwail-accent2 underline underline-offset-2 transition-colors hover:text-cwail-accent">jgonz102@jh.edu</a></p>
                <p className="text-cwail-muted mb-2">Location: Homewood Campus</p>
                <p className="text-cwail-muted mb-2">Joseph Gonzaludo is a rising junior at Johns Hopkins University studying Computer Science, with minors in Entrepreneurship & Management and Writing Seminars. He currently works as a Software Engineering Intern at NASA, where he contributes to mission proposal review systems. He has participated in multiple case competitions, including with Alibaba on AI applications in e-commerce and with AlphaSights on AI implementation strategies.<br/><br/>At Hopkins, Gonzaludo has gained extensive experience in software and web development through both academic and professional settings. His interests lie at the intersection of AI ethics, front-end development, aerospace, and product design. For this project, he is responsible for designing, developing, and maintaining the interactive AI ethics learning modules.</p>
              </div>
            </div>
            </section>
          </RevealOnScroll>
