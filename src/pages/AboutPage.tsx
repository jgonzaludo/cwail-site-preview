          ...
          <RevealOnScroll>
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-cwail-muted mb-2">Joseph Gonzaludo is a rising senior at Johns Hopkins University studying Computer Science, with minors in Entrepreneurship & Management and Writing Seminars. He currently works as a Software Engineering Intern at Balyasny Asset Management. He has participated in multiple case competitions, including with Alibaba on AI applications in e-commerce and with AlphaSights on AI implementation strategies.<br/><br/>At Hopkins, Gonzaludo has gained extensive experience in software and web development through both academic and professional settings. His interests lie at the intersection of AI ethics, front-end development, aerospace, and product design. For this project, he is responsible for designing, developing, and maintaining the interactive AI ethics learning modules.</p>
              </div>
            </div>
            </section>
          </RevealOnScroll>
